...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontFamily: "Poppins_400Regular", fontSize: 15 },
  ...
  resultName: { fontFamily: "Poppins_600SemiBold", fontSize: 14, marginBottom: 8 },
  progressBar: { height: 4, borderRadius: 2, overflow: "hidden", marginBottom: 6 },
  progressFill: { height: 4 },
  resultMeta: { fontFamily: "Poppins_400Regular", fontSize: 12 },
